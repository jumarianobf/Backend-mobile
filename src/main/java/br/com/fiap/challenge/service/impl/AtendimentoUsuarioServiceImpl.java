...
public class AtendimentoUsuarioServiceImpl implements AtendimentoUsuarioService {
    ...
    public AtendimentoUsuarioOdontoprev atualizar(Long id, AtendimentoUsuarioOdontoprev atendimentoAtualizado) {
        ...
        existente.setImagemUrl(atendimentoAtualizado.getImagemUrl()); // ✅ Inclui imagem
    ...
    @Override
    public List<AtendimentoUsuarioOdontoprev> listarPorUsuario(Long usuarioId) {
        return atendimentoUsuarioRepository.findByUsuarioUsuarioId(usuarioId);
    }
